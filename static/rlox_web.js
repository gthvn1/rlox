...
export class Session {
    ...
    scan(input) {
        ...
        try {
            ...
            const ret = wasm.session_scan(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_alert_afcbb608d1214ac8 = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('rlox_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
